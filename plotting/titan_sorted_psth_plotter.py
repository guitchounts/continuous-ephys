	...
	if not 'spikes' in stim_data.columns:
		...
		for i in trials:
		    ...
		    for clust in clusters:
		        ...
		        temp_idx = (cluster_data.times[clust] < trial_time+trial_range) & (cluster_data.times[clust] > trial_time - trial_range)
		#        print temp_idx       
		        clust_trial_times = cluster_data.times[clust][temp_idx] - trial_time	
