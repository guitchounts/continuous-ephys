...
if __name__ == "__main__":
    ...
    for tetrode_num in range(1,8):
        ...
        f,axarr = plt.subplots(len(clusts),3,dpi=600,sharey='col',gridspec_kw={'hspace':2,'wspace':0})
        ...
        for clu_idx,clu in enumerate(clusts):
            for ch in range(4):
                ...
                axarr[clu_idx,0].plot(x,y,c='k',lw=.5)
